...
train_dataset=LiverDataSet(opt.train_data_path)
train_loader=torch.utils.data.DataLoader(train_dataset,batch_size=opt.batch_size,shuffle=True,num_workers=35,pin_memory=False)
...
torch.save(net.module.state_dict(),'./models/UNet'+str(opt.Epochs)+'.pth')
